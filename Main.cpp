...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		component.chair(shaderTex, true, glm::translate(identity, glm::vec3(0.3f, 0.025f, -0.05f)));
		shaderMP.use();
		component.table(shaderMP, false, glm::translate(identity, glm::vec3(2.0f, 0.0f, 0.0f)));
		component.chair(shaderMP, false, glm::translate(identity, glm::vec3(2.3f, 0.025f, -0.05f)));
